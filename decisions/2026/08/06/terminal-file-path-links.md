> Amended on 2026-09-16 by `decisions/2026/09/16/terminal-links-allow-temp-dirs.md`: the path-scope gate also admits the OS temp directories (`os.tmpdir()`, `/tmp` and its real path), not only the home directory and project roots.
