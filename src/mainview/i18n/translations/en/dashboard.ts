const dashboard = {
	...
	"remote.serverDownPort": "Remote access is off — port {port} is already in use",
	"remote.serverDownOther": "Remote access failed to start",
	"remote.serverDownHint": "Free that port or pick another one, then try again. Nothing else in the app is affected.",
	"remote.serverRetry": "Try again",
	"remote.serverRetrying": "Trying…",
	"remote.serverSettingsLink": "Remote access settings",
	...
	"memory.leftoversConfirmBody_one": "Terminates {count} process from finished tasks and frees about {size}. Anything it was still writing is lost.",
	"memory.leftoversConfirmBody_other": "Terminates {count} processes from finished tasks and frees about {size}. Anything they were still writing is lost.",
