const settings = {
	...
	"projectSettings.babysitter": "PR Babysitter",
	"projectSettings.babysitterDesc": "When a task's pull request enters the PR Review column, this agent babysits it: conflicts first, then CI, then review feedback.",
	"projectSettings.babysitterPeerReviewOff": "The PR Review column is disabled for this project (Board tab), so the babysitter never runs.",
	"projectSettings.babysitterAutonomy": "Autonomy",
	"projectSettings.babysitterAutonomyOff": "Off",
	"projectSettings.babysitterAutonomyTriage": "Triage",
	"projectSettings.babysitterAutonomyFix": "Fix",
	"projectSettings.babysitterAutonomyLand": "Land",
	"projectSettings.babysitterAutonomyOffDesc": "No babysitter — PR signals stay passive.",
	"projectSettings.babysitterAutonomyTriageDesc": "Read-only: investigates CI, comments, and conflicts, and reports as a task note. Zero GitHub writes.",
	"projectSettings.babysitterAutonomyFixDesc": "Triage + fixes in the worktree, pushes to the PR branch, replies to comments, rebases on conflict.",
	"projectSettings.babysitterAutonomyLandDesc": "Fix + resolves answered threads, reruns flaky checks, and arms auto-merge once approved and green.",
	"projectSettings.babysitterCustom": "Custom",
	"projectSettings.babysitterHandleComments": "Handle comments",
	"projectSettings.babysitterHandleCommentsDesc": "Triage every new review comment and thread (agree / disagree / already fixed / defer).",
	"projectSettings.babysitterAdvanced": "Advanced",
	"projectSettings.babysitterCapPush": "Push fixes to the PR branch",
	"projectSettings.babysitterCapReply": "Reply to comments",
	"projectSettings.babysitterCapResolve": "Resolve answered threads",
	"projectSettings.babysitterCapRebase": "Rebase on conflicts",
	"projectSettings.babysitterCapRerunChecks": "Rerun flaky checks",
	"projectSettings.babysitterCapArmAutoMerge": "Arm auto-merge",
	"projectSettings.babysitterCeilingsNote": "Hard limits always apply: it never merges directly, never approves, and never edits CI or tests to go green.",
	"projectSettings.babysitterPrompt": "Babysitter Prompt",
	"projectSettings.babysitterPromptReset": "Reset to composed default",
