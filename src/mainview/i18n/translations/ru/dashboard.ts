const dashboard = {
	...
	"remote.serverDownPort": "Удалённый доступ выключен — порт {port} уже занят",
	"remote.serverDownOther": "Удалённый доступ не запустился",
	"remote.serverDownHint": "Освободите этот порт или выберите другой, потом попробуйте снова. На остальное приложение это не влияет.",
	"remote.serverRetry": "Попробовать снова",
	"remote.serverRetrying": "Пробуем…",
	"remote.serverSettingsLink": "Настройки удалённого доступа",
	...
	"memory.leftoversConfirmBody_one": "Завершит {count} процесс от закрытых задач и освободит примерно {size}. Всё, что он не успел записать, потеряется.",
	"memory.leftoversConfirmBody_few": "Завершит {count} процесса от закрытых задач и освободит примерно {size}. Всё, что они не успели записать, потеряется.",
	"memory.leftoversConfirmBody_many": "Завершит {count} процессов от закрытых задач и освободит примерно {size}. Всё, что они не успели записать, потеряется.",
	"memory.leftoversConfirmBody_other": "Завершит {count} процессов от закрытых задач и освободит примерно {size}. Всё, что они не успели записать, потеряется.",
