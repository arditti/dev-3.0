const common = {
	...
	"app.agentCancellationTitle": "Агент просит отменить задачу",
	"app.agentCancellationMessage": "ИИ-агент, работающий над этой задачей, просит ОТМЕНИТЬ её — он считает, что задача не должна существовать и сохранять здесь нечего.\n\nЭто не завершение. Подтверждение выбросит работу: ветка, worktree и всё незакоммиченное в нём будут уничтожены без возможности восстановления.",
	"app.agentCancellationConfirm": "Отменить задачу и удалить работу",
	"app.agentCancellationCancel": "Оставить задачу",
	...
	"traffic.ariaLabelUnread_one": "Трафик агентов: новых с прошлого раза — {count}",
	"traffic.ariaLabelUnread_few": "Трафик агентов: новых с прошлого раза — {count}",
	"traffic.ariaLabelUnread_many": "Трафик агентов: новых с прошлого раза — {count}",
	"traffic.ariaLabelUnread_other": "Трафик агентов: новых с прошлого раза — {count}",
	...
	"traffic.openLog": "Открыть трафик агентов",
	...
	"traffic.notification.level.info": "инфо",
	"traffic.notification.level.success": "успех",
	"traffic.notification.level.error": "ошибка",
	"traffic.notification.outcome.delivered": "Показано вам",
	"traffic.notification.outcome.queued": "Задержано — вы могли его не увидеть",
	"traffic.notification.outcome.noWindow": "Окно было закрыто — ничего не показали",
	"traffic.notification.unrecordedSender": "Отправитель не записан",
	...
	"traffic.experiment.oneHint": "Трёхмерная орбита: задачи — планеты, вокруг которых можно летать.",
	...
	"traffic.nodes.quietCount_one": "{count} задача без переписки",
	"traffic.nodes.quietCount_few": "{count} задачи без переписки",
	"traffic.nodes.quietCount_many": "{count} задач без переписки",
	"traffic.nodes.quietCount_other": "{count} задач без переписки",
	"traffic.nodes.parkedCount_one": "{count} в спячке",
	"traffic.nodes.parkedCount_few": "{count} в спячке",
	"traffic.nodes.parkedCount_many": "{count} в спячке",
	"traffic.nodes.parkedCount_other": "{count} в спячке",
	"traffic.calendar.title": "Выбрать дату",
	"traffic.calendar.today": "Сегодня",
	"traffic.calendar.yesterday": "Вчера",
	"traffic.calendar.previousMonth": "Предыдущий месяц",
	"traffic.calendar.nextMonth": "Следующий месяц",
	"traffic.replay.filters": "Фильтры",
	"traffic.replay.label": "История сообщений",
	"traffic.replay.play": "Воспроизвести",
	"traffic.replay.pause": "Пауза",
	"traffic.replay.previous": "Предыдущее сообщение",
	"traffic.replay.next": "Следующее сообщение",
	"traffic.replay.speed": "Скорость воспроизведения",
	"traffic.replay.restart": "Проиграть",
	"traffic.replay.currentStates": "Overview и заголовки — текущие. При проигрывании статусы восстанавливаются по записанным перемещениям на доске; если записи нет, карточка об этом говорит.",
	"traffic.replay.reconstructedTasks": "Состояния задач восстановлены по записанным перемещениям, а не взяты с доски сейчас.",
	"traffic.replay.taskCreated": "Задача создана",
	"traffic.replay.taskMoved": "Перемещение на доске",
	"traffic.range.label": "Интервал времени",
	"traffic.range.hint": "Потяните, чтобы выбрать интервал; тяните полосу, чтобы сдвинуть его",
	"traffic.range.start": "Начало интервала",
	"traffic.range.end": "Конец интервала",
	"traffic.range.interval": "Выбранный интервал",
	"traffic.celebration.completed": "Завершена",
	"traffic.celebration.worked": "Завершена · {duration} с начала работы",
	...
	"traffic.nodes.nodeCount_one": "{count} узел",
	"traffic.nodes.nodeCount_few": "{count} узла",
	"traffic.nodes.nodeCount_many": "{count} узлов",
	"traffic.nodes.nodeCount_other": "{count} узлов",
	"traffic.nodes.quiet": "В этом окне сообщений не было",
	...
	"traffic.orbit.delivery": "Статус доставки",
	"traffic.orbit.currentTasks": "Состояния задач — текущие; шкала времени фильтрует только сообщения.",
	"traffic.orbit.coordinators": "Координаторы",
	"traffic.orbit.tasks": "Задачи",
	"traffic.orbit.attempts": "Попытки",
	"traffic.orbit.loadError": "Не удалось загрузить часть данных трафика.",
	"traffic.orbit.retry": "Повторить",
	"traffic.orbit.messageTimeline": "Шкала времени сообщений",
	"traffic.orbit.hour": "Последний час",
	"traffic.orbit.day": "Последние 24 часа",
	"traffic.orbit.loadedHistory": "Загруженная история",
	"traffic.orbit.timeWindow": "Период",
	"traffic.orbit.now": "Сейчас",
	"traffic.orbit.inspector": "Подробности задач и сообщений",
	"traffic.orbit.message": "Подробности сообщения",
	"traffic.orbit.runtimeIdle": "Сессия остановлена",
	"traffic.orbit.runtimePreparing": "Сессия запускается",
	"traffic.orbit.runtimeRunning": "Сессия запущена",
	"traffic.orbit.runtimeTearingDown": "Сессия останавливается",
	"traffic.orbit.runtimeHelp": "Запущенная сессия не подтверждает прогресс агента.",
	"traffic.orbit.unknownDelivery": "Статус доставки неизвестен",
	"traffic.orbit.messageCount_one": "{count} записанное сообщение",
	"traffic.orbit.messageCount_few": "{count} записанных сообщения",
	"traffic.orbit.messageCount_many": "{count} записанных сообщений",
	"traffic.orbit.messageCount_other": "{count} записанного сообщения",
	"traffic.orbit.back": "Назад",
	"traffic.orbit.noSubject": "Без темы",
	"traffic.orbit.delivered": "Доставлено",
	"traffic.orbit.held": "Отложено",
	"traffic.orbit.unconfirmed": "Не подтверждено",
	"traffic.orbit.notDelivered": "Не доставлено",
	"traffic.orbit.heldExplanation": "На момент этой попытки сообщение принято для отложенной доставки. Запись не показывает, остаётся ли оно в очереди.",
	"traffic.orbit.deliveredExplanation": "Доставка в панель задачи подтверждена. Это не подтверждение прочтения или выполнения агентом.",
	"traffic.orbit.showPair": "Показать эту пару",
	"traffic.orbit.openTask": "Открыть задачу",
	"traffic.orbit.clear": "Снять выбор",
	"traffic.orbit.historical": "Задача из истории",
	"traffic.orbit.coordinator": "Координатор",
	"traffic.orbit.noOverview": "Обзора пока нет.",
	"traffic.orbit.messages": "Сообщения",
	"traffic.orbit.partial": "Есть более ранние незагруженные записи",
	"traffic.orbit.loadMore": "Загрузить ранние сообщения",
	"traffic.conversation.tab": "Диалог",
	"traffic.conversation.selectTask": "Выберите задачу, чтобы прочитать её диалог с агентом.",
	"traffic.conversation.historical": "У этого узла больше нет задачи на доске — читать нечего.",
	"traffic.conversation.failed": "Не удалось прочитать диалог этой задачи.",
	"traffic.conversation.none": "Читаемого диалога для этой задачи нет. dev3 читает транскрипты Claude Code и Codex; другие агенты не разбираются.",
	"traffic.conversation.session": "Сессия диалога",
	"traffic.conversation.live": "Живой",
	"traffic.conversation.liveHelp": "Прочитано из собственного файла транскрипта агента.",
	"traffic.conversation.archived": "Архив",
	"traffic.conversation.archivedHelp": "Воркtree удалён. Это копия dev3, записанная при завершении задачи, вывод инструментов в ней уже урезан.",
	"traffic.conversation.shown": "{shown} из {total} ходов",
	"traffic.conversation.partial": "Разобрано частично",
	"traffic.conversation.earlier": "Загрузить ранние ходы",
	"traffic.conversation.actions_one": "{count} вызов инструмента",
	"traffic.conversation.actions_few": "{count} вызова инструментов",
	"traffic.conversation.actions_many": "{count} вызовов инструментов",
	"traffic.conversation.actions_other": "{count} вызовов инструментов",
	"traffic.conversation.showMore": "Показать полностью",
	"traffic.conversation.showLess": "Свернуть",
	"traffic.conversation.clipped_one": "Слишком длинно для панели: в транскрипте ещё {count} символ.",
	"traffic.conversation.clipped_few": "Слишком длинно для панели: в транскрипте ещё {count} символа.",
	"traffic.conversation.clipped_many": "Слишком длинно для панели: в транскрипте ещё {count} символов.",
	"traffic.conversation.clipped_other": "Слишком длинно для панели: в транскрипте ещё {count} символов.",
	"traffic.orbit.edgesHelp": "Линии показывают записанные попытки, а не подчинённость.",
	"traffic.orbit.map": "Карта трафика проектов",
	"traffic.orbit.mapHelp": "Перетаскивание — вращение · Прокрутка — масштаб · WASD — перемещение",
	"traffic.orbit.webglError": "3D-карта недоступна. Просматривайте трафик через списки задач и сообщений.",
	"traffic.orbit.resetCamera": "Сбросить камеру",
	...
	"sidebar.allTasksHidden": "Все активные задачи скрыты",
	"sidebar.allTasksHiddenHint": "Нажмите «Показать скрытые задачи» выше, чтобы увидеть их.",
	"sidebar.showHiddenTasks": "Показать скрытые задачи",
	"sidebar.hiddenTaskCount_one": "{count} скрытая задача",
	"sidebar.hiddenAttentionCount_one": "{count} скрытая задача ждёт вас",
	"sidebar.hiddenAttentionCount_few": "{count} скрытые задачи ждут вас",
	"sidebar.hiddenAttentionCount_many": "{count} скрытых задач ждут вас",
	"sidebar.hiddenAttentionCount_other": "{count} скрытых задач ждут вас",
	"sidebar.hiddenTaskCount_few": "{count} скрытые задачи",
	"sidebar.hiddenTaskCount_many": "{count} скрытых задач",
	"sidebar.hiddenTaskCount_other": "{count} скрытых задач",
	...
	"command.category.import": "Импорт",
	...
	"artifactViewer.draftKept": "У вас остался неотправленный ответ на версию {version}.",
	"artifactViewer.draftBack": "Вернуться к версии {version}",
	"artifactViewer.draftDismiss": "Скрыть уведомление",
	"artifactViewer.messageSent": "Отправлено агенту",
	"artifactViewer.messageFailed": "Не удалось отправить агенту",
	"artifactViewer.commentMode": "Комментировать элемент",
	"artifactViewer.commentModeHint": "Нажмите на любой элемент отчёта, чтобы оставить комментарий. Esc выходит из режима.",
	"artifactViewer.reviewTitle": "Ревью",
	"artifactViewer.reviewEmpty": "К этому артефакту пока нет комментариев.",
	"artifactViewer.reviewOutdated": "Не найдено в этой версии",
	"artifactViewer.reviewVersion": "v{version}",
	"artifactViewer.reviewSendAll_one": "Отправить {count} агенту",
	"artifactViewer.reviewSendAll_few": "Отправить {count} агенту",
	"artifactViewer.reviewSendAll_many": "Отправить {count} агенту",
	"artifactViewer.reviewSendAll_other": "Отправить {count} агенту",
