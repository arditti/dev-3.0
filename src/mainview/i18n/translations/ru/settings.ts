const settings = {
	...
	"projectSettings.babysitter": "PR-няня",
	"projectSettings.babysitterDesc": "Когда pull request задачи попадает в колонку PR Review, этот агент присматривает за ним: сначала конфликты, затем CI, затем комментарии ревью.",
	"projectSettings.babysitterPeerReviewOff": "Колонка PR Review отключена для этого проекта (вкладка «Доска»), поэтому няня не запускается.",
	"projectSettings.babysitterAutonomy": "Автономия",
	"projectSettings.babysitterAutonomyOff": "Выкл",
	"projectSettings.babysitterAutonomyTriage": "Триаж",
	"projectSettings.babysitterAutonomyFix": "Фикс",
	"projectSettings.babysitterAutonomyLand": "Лендинг",
	"projectSettings.babysitterAutonomyOffDesc": "Няни нет — сигналы PR остаются пассивными.",
	"projectSettings.babysitterAutonomyTriageDesc": "Только чтение: исследует CI, комментарии и конфликты, отчёт — заметкой в задаче. Никаких записей в GitHub.",
	"projectSettings.babysitterAutonomyFixDesc": "Триаж + правки в worktree, пуш в ветку PR, ответы на комментарии, rebase при конфликте.",
	"projectSettings.babysitterAutonomyLandDesc": "Фикс + закрывает отвеченные треды, перезапускает нестабильные проверки и включает авто-merge после аппрува и зелёного CI.",
	"projectSettings.babysitterCustom": "Своя",
	"projectSettings.babysitterHandleComments": "Обрабатывать комментарии",
	"projectSettings.babysitterHandleCommentsDesc": "Разбирать каждый новый комментарий и тред ревью (согласен / не согласен / уже исправлено / отложить).",
	"projectSettings.babysitterAdvanced": "Дополнительно",
	"projectSettings.babysitterCapPush": "Пушить правки в ветку PR",
	"projectSettings.babysitterCapReply": "Отвечать на комментарии",
	"projectSettings.babysitterCapResolve": "Закрывать отвеченные треды",
	"projectSettings.babysitterCapRebase": "Rebase при конфликтах",
	"projectSettings.babysitterCapRerunChecks": "Перезапускать нестабильные проверки",
	"projectSettings.babysitterCapArmAutoMerge": "Включать авто-merge",
	"projectSettings.babysitterCeilingsNote": "Жёсткие ограничения действуют всегда: агент никогда не мёржит сам, не аппрувит и не правит CI или тесты ради зелёного статуса.",
	"projectSettings.babysitterPrompt": "Промпт няни",
	"projectSettings.babysitterPromptReset": "Сбросить к собранному по умолчанию",
