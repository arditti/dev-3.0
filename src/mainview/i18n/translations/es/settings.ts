const settings = {
	...
	"settings.remoteTunnel": "Túnel de acceso remoto",
	"settings.remoteTunnelDesc": "Cómo se expone la URL de acceso remoto a internet. El Cloudflare quick tunnel integrado no requiere configuración; con tu propio túnel puedes usar cualquier CLI tipo ngrok.",
	...
	"settings.remoteTunnelCommandHint": "{port} se reemplaza por el puerto local. La URL pública se lee de la salida del comando.",
	"settings.remoteTunnelUrlPattern": "Patrón de URL pública (opcional)",
	"settings.remoteTunnelUrlPatternHint": "Expresión regular que coincide con la URL pública en la salida del comando. Vacío = la primera URL https:// impresa.",
