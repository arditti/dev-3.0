const dashboard = {
	...
	"remote.serverDownPort": "El acceso remoto está apagado: el puerto {port} ya está en uso",
	"remote.serverDownOther": "No se pudo iniciar el acceso remoto",
	"remote.serverDownHint": "Libera ese puerto o elige otro y vuelve a intentarlo. El resto de la app no se ve afectada.",
	"remote.serverRetry": "Volver a intentar",
	"remote.serverRetrying": "Intentando…",
	"remote.serverSettingsLink": "Ajustes de acceso remoto",
	...
	"memory.leftoversConfirmBody_one": "Terminará {count} proceso de tareas cerradas y liberará unos {size}. Se pierde lo que estuviera escribiendo.",
	"memory.leftoversConfirmBody_other": "Terminará {count} procesos de tareas cerradas y liberará unos {size}. Se pierde lo que estuvieran escribiendo.",
